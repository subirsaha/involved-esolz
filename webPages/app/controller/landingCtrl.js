    postApp.controller('landingCtrl', function ($scope, $filter, $http,$compile, $location,$timeout,homeService) {
        ...
        $scope.bookDemoSubmit = function()
        {
            ...
            {              
                $('#name').val('');
                $("#name").attr("placeholder","Please enter your name").addClass('red_place');
                error++;
                return false;
            }else{
            ...
            {              
                $('#job_title').val('');
                $("#job_title").attr("placeholder","Please enter job title").addClass('red_place');
                error++;
                return false;
            }else{
            ...
            {              
                $('#school').val('');
                $("#school").attr("placeholder","Please enter your school name").addClass('red_place');
                error++;
                return false;
            }else{
            ...
            {              
                $('#postcode').val('');
                $("#postcode").attr("placeholder","Please enter school postcode").addClass('red_place');
                error++;
                return false;
            }else{
            ...
            document.getElementById("bookDemoCloseBTn").disabled = true;
                ...
                homeService.bookDemoSubmit(name,job_title,email,contact_no,school,postcode,date, function (response)
                {
                    ...
                    if(response == true)
                    {
                        ...
                        $scope.successMsg1 = 'Your demo is not booked.Try again!';
                        $('#successMsg1').click();
                        $('#bookDemoReset').click();
                        $('#bookDemoCloseBTn').click();
                    }
