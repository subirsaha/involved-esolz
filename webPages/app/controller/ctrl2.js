    postApp.controller('ctrl2', function ($scope, $http,$compile, $location,$timeout,loginService, homeService) {
...
/*********************************TEACHER DETAILS & CLASSES begins****************************************************************/
    ...
    /*********************************MY CLASSES SECTION begins****************************************************************/
            ...
            $scope.cancelClickTab=function(val,$event)
            {
                ...
                var file_attachment = $.trim( $('#file_attachment1').val());
                ...
                if(day!=current_day || mnth!=current_month || year!=current_year)
                {
                 ...
                 if ( file_attachment != "" && file_attachment != undefined && file_attachment != "undefined" && file_attachment != null )
                {
               
                   flag++; 
                }
                //alert(StudentIds+'####2'+tasktype+'####3'+title+'####4'+description+'####5'+file_attachment );
                //alert('file = '+file_attachment );
                ...
                //alert('createTask');
                    ...
                    $scope.attach=function()
                    {
                        ...
                        if (fileNum < 4){
                            ...
                            fileNum=fileNum+1;
                                    $('#fileNum').val(fileNum);
                            $('#adddiv1').append('<div class="pdf_pic clearfix" style="cursor: pointer;" id="attachmentCreateTask'+dynamicId+'"><div class="pdf_left attachmentEditNew w3attach"><input id="file_attachment1'+dynamicId+'" click_attr="1" type="file" class="upload file_attachment_class1 inputfile inputfile-1" style="cursor: pointer;display:none;" /><label class="file_div attc" for="file_attachment1'+dynamicId+'"><a class="vcard-hyperlink" href=""><img src="images/push-pin.png" alt=""><span class="ng-binding fleSpan" id="span'+dynamicId+'">Choose file..</span></a></label></div><img onclick="removeAttachmentCreateTask('+dynamicId+');" class="remove_btn_class" style="float: right;" src="images/remove_btn.png" alt=""></div>');
                            $("#file_attachment1"+dynamicId).click();
                            $('#file_attachment1'+dynamicId).bind('change', function(event) {
                                
                                var check_file_status = 0;
                                ...
                                if (tot_file_size >=5120000) {
                                    ...
                                    $("#span"+dynamicId).html(this.files[0].name);
                                    $('#file_attachment1'+dynamicId).attr('disabled',true);
            ...
            $scope.createTaskPopup = function()
            {
                ...
                var nothing="";
                    ...
                    $scope.attach2 = function()
                    {
                        ...
                        if (fileNum < 4){
                             $('#adddiv2').append('<div class="pdf_pic clearfix" style="cursor: pointer;" id="attachmentCreateTaskPopup'+dynamicId+'"><div class="pdf_left w3attach"><input id="file_attachment2'+dynamicId+'" type="file" class="upload file_attachment_class2 inputfile inputfile-1" style="cursor: pointer;" /></label></div><img onclick="removeAttachmentCreateTaskPopup('+dynamicId+');" class="remove_btn_class" style="float: right;" src="images/remove_btn.png" alt=""></div>');
                            $('#file_attachment2'+dynamicId+'').click();
                            $('#file_attachment2'+dynamicId+'').bind('change', function() {
                    ...
                    $scope.cancelClickPop=function()
                    {
                      ...
                      setTimeout(function () {
                       ...
                       $scope.countSelectStudentsTaskPopup = 0;
                        ...
                        var year2 = $('#year2').val();  
                        var StudentIds2 = $('#studentIdsForTaskPopUp').val();
                        var file_attachment =$.trim( $('#file_attachment2').val());
    ...
    /*********************************TASK DESCRIPTION POP UP & EDIT TASK POP UP begins************************/
            $scope.taskDescription = function(taskId,className,taskType,SubjectName,ClassId)
            {
                ...
                $scope.attach3=function()
                {
                    ...
                    {   
                        $('#adddiv').append('<div class="pdf_pic clearfix" style="cursor: pointer;" id="attachmentDivNew'+dynamicId+'"><div class="pdf_left attachmentEditNew w3attach"><input id="file_attachment3'+dynamicId+'" type="file" class="upload file_attachment_class3 inputfile inputfile-1" style="cursor: pointer;" /><label class="file_div" for="file_attachment3'+dynamicId+'"></label></div><img onclick="removeAttachmentNew('+dynamicId+');" class="remove_btn_class" style="float: right;" src="images/remove_btn.png" alt=""></div>');
                        $('#file_attachment3'+dynamicId+'').click();
                        $('#file_attachment3'+dynamicId+'').bind('change', function() {
...
//function removeAttachmentCreateTask(val)
//{
//    //alert(val);
//   //$scope.files.splice(attachmentName,1);
//  
...
// 
//};
//function removeAttachmentNew(val)
//{
//    //alert(val)
//    //$scope.files.splice(attachmentName,1);
//    
...
function printDiv1(divName)
{
    ...
    //mywindow.document.write('<link rel="stylesheet" href="css/font-awesome.min.css"" type="text/css" media="print" />');
    //mywindow.document.write('<link rel="stylesheet" href="css/bootstrap.css" type="text/css" media="print" />');
    //mywindow.document.write('<link rel="stylesheet" href="css/bootstrap-select.css" type="text/css" media="print" />');
    //mywindow.document.write('<link rel="stylesheet" href="css/jquery-ui.css" type="text/css" media="print" />');
    //mywindow.document.write('<link rel="stylesheet" href="css/circle.css" type="text/css" media="print" />');
    //mywindow.document.write('<link rel="stylesheet" href="css/custom.css" type="text/css" media="print" />');
    //mywindow.document.write('<link rel="stylesheet" href="css/developer.css" type="text/css" media="print" />');
    //mywindow.document.write('<link rel="stylesheet" href="css/jquery.mCustomScrollbar.css" type="text/css" media="print" />');
